...
public class VectorLine {
	...
	public Material material {
		...
		set {
			m_material = value;
			if (m_vectorObject != null) {
					m_canvasRenderer.SetMaterial (m_material, m_material.mainTexture);
			}
			if (m_fillObjectSet) {
					m_fillRenderer.SetMaterial (m_material, m_material.mainTexture);
			}
		}
	}
	bool m_active = true;
...
//		else {
	...
	static void SetCanvas () {
		var go = new GameObject("VectorCanvas");
			go.transform.parent = GameObject.Find("EmptyForCanvas").transform;
