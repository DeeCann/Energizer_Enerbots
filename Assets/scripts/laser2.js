...
static var white2:boolean;
static var blue2:boolean;
static var red2:boolean;
static var green2:boolean;
static var yellow2:boolean;
...
static var line2 : VectorLine;
static var line_glass2 : VectorLine;
static var line_water2: VectorLine;
static var line_red2 : VectorLine;
static var line_blue2 : VectorLine;
static var line_yellow2 : VectorLine;
static var line_green2 : VectorLine;
...
line2=VectorLine("Line", linePoints,lineMaterial, 15 ,LineType.Continuous,Joins.None);
line_glass2=VectorLine("Glass_Line", glass_linePoints,lineMaterial, 15 ,LineType.Continuous,Joins.None);
line_water2=VectorLine("Water_Line", water_linePoints,lineMaterial, 2 ,LineType.Continuous,Joins.None);
line_red2=VectorLine("Red_Line", red_linePoints,red_lineMaterial, 15 ,LineType.Continuous,Joins.None);
line_blue2=VectorLine("Blue_Line", blue_linePoints,blue_lineMaterial, 15 ,LineType.Continuous,Joins.None);
line_yellow2=VectorLine("Yellow_Line", yellow_linePoints,yellow_lineMaterial, 15 ,LineType.Continuous,Joins.None);
line_green2=VectorLine("Green_Line", green_linePoints,green_lineMaterial, 15 ,LineType.Continuous,Joins.None);
...
function Update () {
 	...
 	VectorLine.Destroy(line2);
VectorLine.Destroy(line_glass2);
VectorLine.Destroy(line_water2);
VectorLine.Destroy(line_red2);
VectorLine.Destroy(line_blue2);
VectorLine.Destroy(line_yellow2);
VectorLine.Destroy(line_green2);
laser_sound_flag=false;
...
{	
    ...
    line2.points3.Clear();
    line_glass2.points3.Clear();
    line_water2.points3.Clear();
    line_blue2.points3.Clear();
    line_red2.points3.Clear();
    line_green2.points3.Clear();
    line_yellow2.points3.Clear();
    verti = 1;
    iactive = true;
    currot = offset;
    curpos = transform.position;
	
 	line2.points3.Add (transform.position);
    while(iactive)
    {
        ...
        if (Physics.Raycast(curpos,currot,hit,dist))
        {
            ...
            if (hit.transform.gameObject.tag == "absorber"){
                ...
                white2=true;next_lvl();
                
            }
           
            if (hit.transform.gameObject.tag == "glass"){
            	line_glass2.points3.Add(curpos);
            	glass_rot=currot;
            	...
            	while(glass_active){
            		...
            		if(Physics.Raycast(glass_pos,glass_rot,hit_glass,dist)){
		            	...
		            	line_glass2.points3.Add(hit_glass.point);
		            	if (hit_glass.transform.gameObject.tag == "a"){
                			glass_active=false;
           				 	}
		            	if (hit_glass.transform.gameObject.tag == "absorber"){
		                	glass_active = false;level_completed();white2=true;
		            		}
		            	...
		            	if (hit_glass.transform.gameObject.tag == "blue"){
			            	...
			            	while(blue_active){
				            	if(Physics.Raycast(blue_pos,blue_rot,hit_blue,dist)){
					            	...
					            	line_blue2.points3.Add(hit_blue.point);
			            	...
			            	while(red_active){
				            	if(Physics.Raycast(red_pos,red_rot,hit_red,dist)){
					            	...
					            	line_red2.points3.Add(hit_red.point);
			            	...
			            	glass_active = false;
			            	line_green2.points3.Add(glass_pos);
			            	...
			            	while(green_active){
				            	if(Physics.Raycast(green_pos,green_rot,hit_green,dist)){
					            	...
					            	line_green2.points3.Add(hit_green.point);
			            	...
			            	glass_active = false;
			            	line_yellow2.points3.Add(glass_pos);
			            	...
			            	while(yellow_active){
				            	if(Physics.Raycast(yellow_pos,yellow_rot,hit_yellow,dist)){
					            	...
					            	line_yellow2.points3.Add(hit_yellow.point);
            ...
            if (hit.transform.gameObject.tag == "water"){
            	...
            	line_water2.points3.Add(curpos);
            	water_rot=currot;
            	...
            	while(water_active){
            		...
            		if(Physics.Raycast(water_pos,water_rot,hit_water,dist)){
		            	...
		            	line_water2.points3.Add(hit_water.point);
		            	if (hit_water.transform.gameObject.tag == "a"){
                			water_active=false;
           				 }
		            	if (hit_water.transform.gameObject.tag == "absorber"){
		                	water_active = false;level_completed();white2=true;
		            		}
